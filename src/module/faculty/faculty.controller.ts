...
const updateContact = catchAsync(async (req: Request, res: Response,) => {
    ...
    const result = await facultyService.updateContact(req.user?.id as string, email, phone);
    sendResponse(res, {
        statusCode: status.OK,
        ok: true,
...
const updateAddress = catchAsync(async (req: Request, res: Response,) => {
    ...
    const result = await facultyService.updateAddress(req.user?.id as string, presentAddress, permanentAddress);
    sendResponse(res, {
        statusCode: status.OK,
        ok: true,
