...
import { CourseOfferingZodSchema, CourseZodSchema, createBatchZodSchema, UpdateProfileZodSchema } from "./admin.validation";
...
router.patch("/profile", validateRequest(UpdateProfileZodSchema), adminController.updateProfile);
